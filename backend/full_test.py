...
DB_URL = "postgresql://postgres:***REMOVED***@127.0.0.1:5432/blackspire"
...
try:
    login_data = json.dumps({'email': 'yaswanthparimi53@gmail.com', 'password': '***REMOVED***', 'role': 'seller'}).encode()
